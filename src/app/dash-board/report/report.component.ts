  ...
  createDataGrid001(): void {
    ...
    this.gridOptions.columnDefs = [
      ...
      },
      {
        ...
        resizable: true,
        suppressSizeToFit: true,
        valueGetter: this.setTargetVersion.bind(this)
      },
      {
        ...
        resizable: true,
        suppressSizeToFit: true,
        valueGetter: this.setTargetCollection.bind(this)
      },
      {
        ...
        resizable: true,
        suppressSizeToFit: true,
        valueGetter: this.setTargetName.bind(this)
      },
      {
        headerName: 'Acronym',
        field: 'acronym',
        ...
        resizable: true,
        suppressSizeToFit: true,
        valueGetter: this.setTargetAcronym.bind(this)
      },
      {
        ...
        resizable: true,
        suppressSizeToFit: true,
        valueGetter: this.setTargetOrganism.bind(this)
      },
      {
        headerName: 'Variant',
        field: 'variant',
        ...
        resizable: true,
        suppressSizeToFit: true,
        valueGetter: this.setTargetVariant.bind(this)
      },
// -----------Assay---------------------
{
  headerName: 'Ligand-Version',
...
},
{
  ...
  resizable: true,
  suppressSizeToFit: true,
  valueGetter: this.setAssayOrdinal.bind(this)
},
{
...
},
{
  ...
  resizable: true,
  suppressSizeToFit: true,
  valueGetter: this.setLigandSingleValue.bind(this)
},
{
...
},
{
  ...
  resizable: true,
  suppressSizeToFit: true,
  valueGetter: this.setLigandHighValue.bind(this)
},
{
  ...
  resizable: true,
  suppressSizeToFit: true,
  valueGetter: this.setLigandLowValue.bind(this)
},
...
},
{
  ...
  resizable: true,
suppressSizeToFit: true,
valueGetter: this.setAdministration.bind(this)
},
{
  ...
  resizable: true,
  suppressSizeToFit: true,
  valueGetter: this.setProcedure.bind(this)
},
{
  ...
  resizable: true,
suppressSizeToFit: true,
valueGetter: this.setConditionTypeValue.bind(this)
},
{
  ...
  resizable: true,
suppressSizeToFit: true,
valueGetter: this.setConditionMaterialValue.bind(this)
},
{
  ...
  resizable: true,
  suppressSizeToFit: true,
  valueGetter: this.setConditionMaterialIdValue.bind(this)
},
{
  ...
  resizable: true,
  suppressSizeToFit: true,
  valueGetter: this.setConditionSingleValue.bind(this)
},
{
  ...
  resizable: true,
  suppressSizeToFit: true,
  valueGetter: this.setConditionUnitValue.bind(this)
},
{
  ...
  resizable: true,
  suppressSizeToFit: true,
  valueGetter: this.setConditionHighValue.bind(this)
},
{
  ...
  resizable: true,
  suppressSizeToFit: true,
  valueGetter: this.setConditionLowValue.bind(this)
},
{
  headerName: 'Unit',
  field: 'highLowUnit',
  ...
  resizable: true,
  suppressSizeToFit: true,
  valueGetter: this.setConditionLowHighUnitValue.bind(this)
},
// -----------Measurement---------------------
{
  headerName: 'Ligand-Version',
...
},
{
  ...
  // setParameterDetailsValue(params: any) {
  //   return params.data? params.data.parameterDetail : null;
  // }

  // setParameterValue(params: any) {
  //   return params.data? params.data.parameter : null;
  // }
  ...
  // setDataLocatorValue(params: any) {
  //   return params.data? params.data.dataLocator : null;
  // }

  // -----------Assay---------------------
  setConditionLowHighUnitValue(params: any) {
    return params.data.assaySlno2 ? params.data.assaySlno2.highLowUnit : null;
  }

  setConditionLowValue(params: any) {
    return params.data.assaySlno2 ? params.data.assaySlno2.lowCondition : null;
  }

  setConditionHighValue(params: any) {
    return params.data.assaySlno2 ? params.data.assaySlno2.highCondition : null;
  }

  setConditionUnitValue(params: any) {
    return params.data.assaySlno2 ? params.data.assaySlno2.singleUnit : null;
  }

  setConditionSingleValue(params: any) {
    return params.data.assaySlno2 ? params.data.assaySlno2.singleCondition : null;
  }

  setConditionMaterialIdValue(params: any) {
    return params.data.assaySlno2 ? params.data.assaySlno2.conditionMaterialid : null;
  }

  setConditionMaterialValue(params: any) {
    return params.data.assaySlno2 ? params.data.assaySlno2.conditionMaterial : null;
  }

  setConditionTypeValue(params: any) {
    return params.data.assaySlno2 ? params.data.assaySlno2.conditionType : null;
  }

  setProcedure(params: any) {
    return params.data.assaySlno2 ? params.data.assaySlno2.procedure : null;
  }

  setAdministration(params: any) {
    return params.data.assaySlno2 ? params.data.assaySlno2.administration : null;
  }
  ...
  setLigandLowValue(params: any) {
    return params.data.assaySlno2 ? params.data.assaySlno2.ligandLvalue : null;
  }

  setLigandHighValue(params: any) {
    return params.data.assaySlno2 ? params.data.assaySlno2.ligandHvalue : null;
  }
  ...
  setLigandSingleValue(params: any) {
    return params.data.assaySlno2 ? params.data.assaySlno2.ligandSvalue : null;
  }
  ...
  setAssayOrdinal(params: any) {
    return params.data.assaySlno2 ? params.data.assaySlno2.ordinal : null;
  }

  // -----------Ligand---------------------
  setTargetVariant(params: any) {
    return params.data.assaySlno2 ? params.data.assaySlno2.ligandSlno2.variant : null;
  }

  setTargetOrganism(params: any) {
    return params.data.assaySlno2 ? params.data.assaySlno2.ligandSlno2.organism : null;
  }

  setTargetAcronym(params: any) {
    return params.data.assaySlno2 ? params.data.assaySlno2.ligandSlno2.acronym : null;
  }

  setTargetName(params: any) {
    return params.data.assaySlno2 ? params.data.assaySlno2.ligandSlno2.original : null;
  }

  setTargetCollection(params: any) {
    return params.data.assaySlno2 ? params.data.assaySlno2.ligandSlno2.collectionId1 : null;
  }

  setTargetVersion(params: any) {
    return params.data.assaySlno2 ? params.data.assaySlno2.ligandSlno2.targetVersion : null;
  }

  setDiseaseName3(params: any) {
    return params.data.assaySlno2 ? params.data.assaySlno2.ligandSlno2.diseaseName3 : null;
  }

  setDiseaseName2(params: any) {
    return params.data.assaySlno2 ? params.data.assaySlno2.ligandSlno2.diseaseName2 : null;
  }

  setDiseaseName1(params: any) {
    return params.data.assaySlno2 ? params.data.assaySlno2.ligandSlno2.diseaseName1 : null;
  }

  setLigandLocator(params: any) {
    return params.data.assaySlno2 ? params.data.assaySlno2.ligandSlno2.locator : null;
  }

  setLigandCollection(params: any) {
    return params.data.assaySlno2 ? params.data.assaySlno2.ligandSlno2.collectionId : null;
  }

  setIdentifier3(params: any) {
    return params.data.assaySlno2 ? params.data.assaySlno2.ligandSlno2.identifier3 : null;
  }

  setIdentifier2(params: any) {
    return params.data.assaySlno2 ? params.data.assaySlno2.ligandSlno2.identifier2 : null;
  }

  setIdentifier1(params: any) {
    return params.data.assaySlno2 ? params.data.assaySlno2.ligandSlno2.identifier1 : null;
  }

  setLigandDetails(params: any) {
    return params.data.assaySlno2 ? params.data.assaySlno2.ligandSlno2.ligandDetail : null;
  }
  ...
  settanNumber(params: any) {
    return params.data.assaySlno2 ? params.data.assaySlno2.ligandSlno2.tanNumber : null;
  }
